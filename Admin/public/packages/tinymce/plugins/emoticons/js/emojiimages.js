...
window.tinymce.Resource.add("tinymce.plugins.emoticons", {
  ...
  taxi: {
    keywords: [ "uber", "vehicle", "facts", "transportation" ],
  ...
  police_car: {
    keywords: [ "vehicle", "facts", "transportation", "law", "legal", "enforcement" ],
  ...
  fire_engine: {
    keywords: [ "transportation", "facts", "vehicle" ],
  ...
  articulated_lorry: {
    keywords: [ "vehicle", "facts", "transportation", "express" ],
  ...
  parking: {
    keywords: [ "facts", "blue-square", "alphabet", "letter" ],
